...
export const I18N: Record<Language, Translations> = {
  "es": {
    ...
    "filters": {
      ...
      "searchBtn": "🔍 Buscar",
      "all": "🔘 Todas Ligas",
      "highAlerts": "🟢🔵 Alerta Todas",
      "highToday": "🟢🔵 Alertas Hoy",
      "liveOnly": "🔴 En Vivo",
    ...
    "telegramModal": {
      ...
      "channelTitle": "🏆 EnRachas VIP Signals",
      ...
      "footerNote": "🤖 Alerta generada automáticamente por EnRachas Engine"
    },
    "pricingModal": {
    ...
    "transparencyModal": {
      ...
      "subtitle": "Rendimiento auditado de EnRachas segregado estrictamente por categoría metodológica.",
      ...
      "bannerRealDesc": "Señales auditadas y liquidadas directamente en el Ledger Inmutable oficial de EnRachas.",
  ...
  "en": {
    ...
    "telegramModal": {
      ...
      "footerNote": "🤖 Signal generated by EnRachas Quantitative Engine"
    },
    "pricingModal": {
    ...
    "guideModal": {
      ...
      "principleDesc": "EnRachas detects leagues accumulating anomalous sequences of matches without a specific event. When an alert reaches Green / Blue status, your market order is the break event:",
      "steps": [
        {
    ...
    "transparencyModal": {
      ...
      "subtitle": "EnRachas audited performance segregated strictly by quantitative methodological track.",
      "trackReal": "🛡️ REAL RESULTS (Immutable Ledger)",
      "trackPaper": "🧪 PAPER TRADING (Forward Test)",
      "trackBacktest": "📈 BACKTEST (3-Season Historical)",
      "bannerRealDesc": "Audited and settled signals directly verified on EnRachas's official Immutable Ledger.",
  ...
  "pt": {
    ...
    "header": {
      ...
      "exportCsv": "📋 Relatório de Sequências",
      "telegram": "🤖 Bot Telegram",
      "pricing": "💎 Ver Planos",
    ...
    "filters": {
      ...
      "searchBtn": "🔍 Buscar",
      "all": "🔘 Todas Ligas",
      "highAlerts": "🟢🔵 Todos os Alertas",
      "highToday": "🟢🔵 Alertas de Hoje",
      "liveOnly": "🔴 Ao Vivo",
    ...
    "telegramModal": {
      ...
      "footerNote": "🤖 Alerta gerado automaticamente pelo EnRachas Engine"
    },
    "pricingModal": {
    ...
    "transparencyModal": {
      ...
      "subtitle": "Desempenho auditado do EnRachas segregado estritamente por metodologia quantitativa.",
      "trackReal": "🛡️ RESULTADOS REAIS (Ledger Imutável)",
      "trackPaper": "🧪 PAPER TRADING (Forward Test)",
      "trackBacktest": "📈 BACKTEST (Histórico 3 Temp)",
      "bannerRealDesc": "Sinais auditados e liquidados diretamente no Ledger Imutável oficial do EnRachas.",
  ...
  "gn": {
    ...
    "telegramModal": {
      ...
      "footerNote": "🤖 Alerta omoheñói automáticamente EnRachas Engine"
    },
    "pricingModal": {
    ...
    "transparencyModal": {
      ...
      "subtitle": "EnRachas rendimiento auditado oñemboja'óva categoría metodológica rupive.",
      "trackReal": "🛡️ RESULTADOS REALES (Ledger Inmutable)",
      "trackPaper": "🧪 PAPER TRADING (Forward Test)",
      "trackBacktest": "📈 BACKTEST (Histórico 3 Temp)",
      "bannerRealDesc": "Señales auditadas ha liquidadas directamente Ledger Inmutable oficial EnRachas-pe.",
